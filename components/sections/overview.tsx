...
export function Overview() {
  return (
    <section id="overview" aria-labelledby="overview-title" className="bg-black">
      <div className="mx-auto max-w-6xl px-4 py-14 sm:py-16 md:py-20">
        <h2 id="overview-title" className="text-balance text-2xl sm:text-3xl font-semibold flex items-center gap-2">
        ...
        <div className="mt-8 grid grid-cols-1 gap-5 sm:gap-6 sm:grid-cols-2">
          {[
            {
            ...
            <article key={item.title} className="rounded-lg border border-border bg-card p-4 sm:p-5">
